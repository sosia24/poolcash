...
    // Função de limpeza para remover ouvintes quando o componente for desmontado
    return () => {
      if (typeof window !== "undefined" && (window as any).ethereum) {
        const ethereum = (window as any).ethereum;
...
    if (!accounts || accounts.length === 0) throw new Error("No accounts found / wallet denied.");
